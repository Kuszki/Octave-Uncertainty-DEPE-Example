...
subplot(2, 3, 4)
hist(x, 300, 100, "facecolor", 0.15*[1 1 1], "edgecolor", 0.15*[1 1 1])
title(sprintf("(d)\\rm {\\it{}N} = 128, {\\it{}K} = 9, {\\it{}U_{\\delta}} = %0.2g%%", get_uncertainty(x)))
xlabel("Error value, %")
ylabel("Occurences, %")
xlim([-100 100])
set_format(gca, 'Title', false);
...
subplot(2, 3, 5)
hist(x, 300, 100, "facecolor", 0.15*[1 1 1], "edgecolor", 0.15*[1 1 1])
title(sprintf("(e)\\rm {\\it{}N} = 256, {\\it{}K} = 9, {\\it{}U_{\\delta}} = %0.2g%%", get_uncertainty(x)))
xlabel("Error value, %")
ylabel("Occurences, %")
xlim([-50 50])
set_format(gca, 'Title', false);
...
subplot(2, 3, 6)
hist(x, 300, 100, "facecolor", 0.15*[1 1 1], "edgecolor", 0.15*[1 1 1])
title(sprintf("(f)\\rm {\\it{}N} = 512, {\\it{}K} = 9, {\\it{}U_{\\delta}} = %0.2g%%", get_uncertainty(x)))
xlabel("Error value, %")
ylabel("Occurences, %")
xlim([-50 50])
set_format(gca, 'Title', false);
